			...
			<div class="relative h-full ml-auto lg:w-6/12">
				<div class="m-auto py-12 px-6 sm:p-20 xl:w-10/12">
					<div class="space-y-4">
						...
						<p class="text-5xl text-black">Reset Password</p>
					</div>
					<div class="w-20">
					...
					<form action="" class="space-y-6 py-6">
						...
						<div>
							<div class="w-full flex justify-end">
								<a href="/login" type="reset" class="w-max pt-0 pb-4 pr-4">
									<span class="text-xs tracking-wide text-blue-600">Login?</span>
								</a>
							</div>
							...
							>
								<span class="font-semibold text-white text-lg">Reset Password</span>
							</button>
						</div>
					</form>
				</div>
